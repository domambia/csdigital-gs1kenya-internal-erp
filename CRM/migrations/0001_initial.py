    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_name', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='CRM.Client')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('all_trainee', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[(1, 'BrugKe'), (2, 'gs1')], max_length=3, null=True)),
                ('happened_on', models.DateField(default=datetime.datetime.now)),
                ('description', models.CharField(max_length=2000)),
                ('trainer', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='accounts.Employee')),
            ],
        ),
        migrations.AddField(
            model_name='event',
            name='training',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='trian', to='CRM.Training'),
        ),
        migrations.AddField(
            model_name='barcode',
            name='client',
